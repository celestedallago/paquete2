#' Datos meteorológicos sin procesar
#'
#' Un conjunto de datos que contiene información meteorológica en bruto, antes de ser procesada.
#'
#' @format Un data frame con 17041 filas y 35 columnas:
#' \describe{
